...
<body class="gray-bg">
        ...
        <div class="row">
			 ...
			 <div class="form-horizontal m-t">			  
			  <div class="form-group col-lg-7">
                 ...
                 <div class="col-sm-8">
                     <input placeholder="开始时间" id="txt_search_start" name="entrytime1" class="laydate-icon form-control layer-date"/>
                     <input placeholder="结束时间"id="txt_search_end" name="entrytime2" class="laydate-icon form-control layer-date"/>
                 </div>
	          </div>
		  	</div>
	...
	<!-- 新增课程对话框 -->
	<div class="modal fade" id="modal_user_course" role="dialog" aria-labelledby="modal_user_course" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_course" method="post" action="reserveCourse.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>课程名：</td>
								<td>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_course_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	<!--导出对话框 -->
	<div class="modal fade" id="modal_user_out" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				...
				<div class="modal-footer">
				<button type="button" class="btn btn-danger"  id="out_user_btn">导出</button>
				<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
			</div>
			</div>
		</div>
	...
	<div class="modal fade" id="modal_user_count" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					 <h4 class="modal-title" id="modal_user_del_head"> 饼状图  </h4>
				</div>
				<div class="modal-body">
	...
	$(function () {
	  ...
	  //添加课程
	    var validator = $("#form_course").validate({
    		submitHandler: function(form){
   		      $(form).ajaxSubmit({
   		    	dataType:"json",
   		    	success: function (data) {
	    ...
	    $("#submit_form_course_btn").click(function(){
	    	$("#form_course").submit();
	    });
	});
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            entrytime1: $("#txt_search_start").val(),
	            entrytime2: $("#txt_search_end").val(),
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_course").click(function(){
	    		...
	    		$('#modal_user_course').modal({backdrop: 'static', keyboard: false});
				$('#modal_user_course').modal('show');
	        });
	    	...
	    	$("#btn_out").click(function(){
	    			$('#modal_user_out').modal({backdrop: 'static', keyboard: false});
	    			$("#modal_user_out").show();
	        });
	        //饼状图
	...
	function initEditUser(getSelection){
		...
		$('#username').val(getSelection.name);
